...
if (isset($_POST['editbook'])) {
    ...
    $sql = "UPDATE livros SET 
        titulo='$titulo', quantidade='$qtd', data_pub='$data', autor='$autor', editora='$editora',
        situacao='$situacao', observacao='$obs', sinopse='$sinopse', genero='$genero',
        faixa='$faixa', localizacao='$local'";
